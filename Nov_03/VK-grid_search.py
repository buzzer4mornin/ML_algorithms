...
def main(args):
    ...
    pipe = sklearn.pipeline.Pipeline([('minmax', sklearn.preprocessing.MinMaxScaler()),('poly', sklearn.preprocessing.PolynomialFeatures()), ('logreg', sklearn.linear_model.LogisticRegression(random_state=args.seed))])
    ...
    params = [{'poly__degree':[1,2], 'logreg__C':[0.01,1,100], 'logreg__solver':['lbfgs','sag']}]
